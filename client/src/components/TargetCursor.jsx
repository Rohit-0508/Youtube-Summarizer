...
const TargetCursor = ({
    ...
    }, [location.pathname, spinDuration, constants]);
    ...
    useEffect(() => {
        ...
        const observer = new MutationObserver(() => {
            const disabled = document.body.hasAttribute("data-cursor-disabled");

            cursorRef.current.style.display = disabled ? "none" : "block";
            document.body.style.cursor = disabled ? "auto" : "none";
        });

        observer.observe(document.body, {
            attributes: true,
            attributeFilter: ["data-cursor-disabled"],
        });
